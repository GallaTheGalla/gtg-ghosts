...
let version_history = [

	{
		...
		comment: "Idea Adoption Jam 2023 release",
	},
	{
		version: "v1.0.1",
		...
		comment: "Integrated balloon updates to new nars. Added 1 new dialogue.",
	},
	{
		version: "v1.1.0",
		...
		comment: "Added ~99 new dialogues, bringing the total to 200. Made minor adjustments to some existing dialogues. Various small tweaks.",
	},
	{
		version: "v1.1.1",
		download: latest_version,
		comment: "Added custom calibration for the plugin Spectre.",
	}
