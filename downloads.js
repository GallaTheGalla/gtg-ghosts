//Most recent downloads, since these need to appear both on the indexes and in the version histories
...
let ghost_downloads = {
	...
	"left_unattended": "https://github.com/Zichqec/left_unattended/releases/download/v1.1.0/left_unattended_v1.1.0.nar",
	...
	"ghost_yaminabe": "https://cherry.narnaloader.ukagaka.net/ghost.php?ghost=ghost_yaminabe",
	"ghost_yaminabe_okawari": "https://cherry.narnaloader.ukagaka.net/ghost.php?ghost=yaminabe_okawari"

}

//————————————————————————————— Balloons —————————————————————————————
let balloon_downloads = {

	"angelbox": "https://github.com/Zichqec/SSP_Angel_Balloons/releases/download/v1.0.0/angelbox.nar",
	"angelbox_biblically_accurate": "https://github.com/Zichqec/SSP_Angel_Balloons/releases/download/v1.0.0/angelbox_biblically_accurate.nar",
	"balloons_balloon": "https://ukagaka.zichqec.com/balloon/balloons_balloon",
	"blopblop": "https://github.com/GallaTheGalla/blopy/releases/download/v1.0.0/blopy.nar",
	"bowie_wilson_balloon_colours_edition": "https://github.com/StrangelyKai/Bowie-Wilson-Balloon-COLOURS-EDITION/blob/main/bowie_wilson_COLOURS.nar",
	"cotton_candy": "https://github.com/Zichqec/SSP_Angel_Balloons/releases/download/v1.0.0/cotton_candy.nar",
	"dine-in_breakfast": "https://github.com/GallaTheGalla/dine_in_breakfast/releases/download/v1.0.0/dine_in_breakfast_v1.0.0.nar",
	...
	"noodloon": "https://github.com/GallaTheGalla/noodloon/releases/download/v1.0.0/noodloon_v1.0.0.nar",
	"open_exhibition": "https://github.com/GallaTheGalla/open_exhibition/releases/download/v1.0.0/open_exhibition_v1.0.0.nar",
	"paperboard": "https://ukagaka.zichqec.com/balloon/paperboard",
	"pixeloon": "https://github.com/StrangelyKai/Pixeloon-Balloon/blob/main/pixeloon.nar",
	"rose_vine": "https://github.com/GallaTheGalla/rose_vine/releases/download/v1.0.0/rose_vine_v1.0.0.nar",
	"rose_vine_s": "https://github.com/GallaTheGalla/rose_vine/releases/download/v1.0.0/rose_vine_s_v1.0.0.nar",
	"snail_balloon": "https://github.com/GallaTheGalla/snail_b_gcm/releases/download/v1.0.1/snail_b_gcm_v1.0.1.nar",
	"spirit_detective": "https://github.com/GallaTheGalla/spirit_detective/releases/download/v1.0.2/spirit_detective_v1.0.2.nar",
	"spirit_detective_r": "https://github.com/GallaTheGalla/spirit_detective/releases/download/v1.0.2/spirit_detective_r_v1.0.2.nar",
	"spirit_detective_s": "https://github.com/GallaTheGalla/spirit_detective/releases/download/v1.0.2/spirit_detective_s_v1.0.2.nar",
	"squidloon": "https://github.com/GallaTheGalla/squidloon/releases/download/v1.0.1/squidloon_v1.0.1.nar",
	"stuck_to_a_filing_cabinet": "https://github.com/GallaTheGalla/stuck_to_a_filing_cabinet/releases/download/v1.0.0/stuck_to_a_filing_cabinet_v1.0.0.nar",
	"tropical_plastic": "https://github.com/GallaTheGalla/tropical_plastic/releases/download/v1.0.2/tropical_plastic_v1.0.2.nar",
	"wedges_balloon_pack": "https://ukagaka.zichqec.com/balloon/wedges_balloon_pack"

}

//—————————————————————————— Calendar skins ——————————————————————————
let calendar_skin_downloads = {

	"forged_metal_calendar": "https://github.com/GallaTheGalla/forged_metal_calendar/releases/download/v1.0.0/forged_metal_calendar_v1.0.0.nar",
	"wedges_calendar_skin_pack": "https://ukagaka.zichqec.com/calendar_skin/wedges_calendar_skin_pack"
...
let shell_downloads = {
	...
	"i_died_and_turned_into_a_well_hydrated_hamster": "https://github.com/GallaTheGalla/i_died_and_turned_into_a_well_hydrated_hamster/releases/download/v1.0.1/i_died_and_turned_into_a_well_hydrated_hamster_v1.0.1.nar",
	"slimedration": "https://github.com/GallaTheGalla/slimedration/releases/download/v1.0.1/slimedration_v1.0.1.nar",
	
	"correctly_drawn_flamingo": "https://github.com/GallaTheGalla/correctly_drawn_flamingo/releases/download/v1.0.0/correctly_drawn_flamingo_v1.0.0.nar",
