let reviewurl = "https://docs.google.com/forms/d/e/1FAIpQLSfJHpRDJhnYxhfyImtJMdVnYFwRO7Wp9wMoJnYxNcJSENe6bw/viewform?usp=sf_link";

let latest_version = "";
if (typeof balloon_downloads != "undefined") //Check if we're on a page that needs this info, to avoid an error
{
	latest_version = balloon_downloads["dine-in_breakfast"]
