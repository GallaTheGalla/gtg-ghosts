let reviewurl = "https://docs.google.com/forms/d/e/1FAIpQLSfQxoS5UdaWjUsiudOpfaW4EAc2sKhZJbMBXytT0oE_pz7eJQ/viewform?usp=sf_link";

let latest_version = "";
if (typeof balloon_downloads != "undefined") //Check if we're on a page that needs this info, to avoid an error
{
	latest_version = balloon_downloads["stuck_to_a_filing_cabinet"]
