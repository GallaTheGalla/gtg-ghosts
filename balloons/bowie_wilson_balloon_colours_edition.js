let reviewurl = "https://docs.google.com/forms/d/e/1FAIpQLSe3eYVtrbJpy5xKUJO53gNU4s4zVYEdhRkuHHP9hYRpR4oocA/viewform?usp=sf_link";

let latest_version = "";
if (typeof balloon_downloads != "undefined") //Check if we're on a page that needs this info, to avoid an error
{
	latest_version = balloon_downloads["bowie_wilson_balloon_colours_edition"]
