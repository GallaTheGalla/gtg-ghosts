let reviewurl = "https://docs.google.com/forms/d/e/1FAIpQLSc56MFVnX6foo8avDZNiFuEAOhHhap2dU0iJYN9OBYgZXNilA/viewform?usp=sf_link";

let latest_version = "";
if (typeof balloon_downloads != "undefined") //Check if we're on a page that needs this info, to avoid an error
{
	latest_version = balloon_downloads["angelbox"]
